...
function Home() {
  ...
  return (
    <div
      className="flex  w-full flex-col bg-cover bg-center items-center md:flex-row justify-around h-screen"
      style={{ backgroundImage: "url('/home.jpg')" }}
    >
      {" "}
      {/* Flexbox for centering */}
      <div className="text-center">
        <h1 className="text-5xl mt-5 font-extrabold md:text-8xl text-white">
          Quizie
        </h1>
        {/* Animated Text */}
        <div
      ...
      <div>
        <img src="/chest.png" alt="Light Mode" className="w-80" />
      </div>
    </div>
  );
}
